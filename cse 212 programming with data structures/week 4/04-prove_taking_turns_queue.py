...
# The first thing that I needed to change was in the enqueue function. I changed it
# from insert to append, that way, I was adding the values at the end of the queue. I
# also needed to fix the get_next_person function because it was not accounting for
# people that had 0, which means that it will go forever, as turns.